...
\textbf{ni} && \textit{substantive demonstrative pronoun}: this, that \\ % no-dictionary
 && \\ % no-dictionary
...
%
% A reflexive pronoun represents the noun in the direct object.
%
...
%
%
\index{\textit{demonstrative pronoun}}

...
What's a pronoun?  &&  A pronoun is a proxy for a noun. \\ % no-dictionary
...
When can a verb slot be empty?  &&   If the predicate is formed by a noun (predicate noun) or adjective (predicate adjective).  \\ % no-dictionary
What is a predicate?  &&   It is a core element in a sentence and it is the statement of the sentence. \\ % no-dictionary
...
Where are possible adjective slots?  &&  After a noun, after a pronoun and according to \textit{li} (predicate adjective). \\  % no-dictionary

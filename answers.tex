...
What is a possessive pronoun? && A possessive pronoun expresses a characteristic or affiliation. It replaced an adjective.  \\ % no-dictionary
Where is a slot for a substantive demonstrative pronoun possible? && Instead of a noun. \\ % no-dictionary
Which separator is at the end of a declarative sentence? && A full stop. \\ % no-dictionary
What is a predicate adjective? && An adjective that is used as predicate. There is then no verb in the predicate. \\ % no-dictionary
Which sentence phrases can contain spatial nouns be found? && In an indirect object or prepositional object. All object types belong to the predicate phrase.  \\ % no-dictionary
\end{supertabular}

...
\textbf{kepeken \dots} && \textit{preposition}: with, using \\ 
...
\textbf{lon \dots} && \textit{preposition}: be (located) in/at/on \\ 
...
% \textbf{poka \dots} && \textit{preposition}: in the accompaniment of, with \\ 
 && \\ % no-dictionary
...
\textbf{sama \dots} && \textit{preposition}: like, as, seem \\ 
...
\textbf{tan \dots} && \textit{preposition}: from, by, because of, since \\ 
...
\textbf{tawa \dots} && \textit{preposition}: to, in order to, towards, for, until \\ 

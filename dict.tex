...
\textbf{ante la \dots} && \textit{conditional}: otherwise, on the other hand  \\ 
 && \\ % no-dictionary
...
\textbf{ike la \dots} && \textit{conditional}: unfortunately \\ 
 && \\ % no-dictionary
...
\textbf{ken la \dots)} && \textit{conditional}: maybe \\ 
 && \\ % no-dictionary
...
\textbf{kin la \dots} && \textit{conditional}: moreover, in addition, likewise \\ 
...
\textbf{kute (e \dots)} && \textit{verb transitive}: to hear, to listen, \\ 
 && \\ % no-dictionary
\textbf{\dots la \dots} && \textit{separator}: A "la" is between the context phrase and the main sentence. \\ && Don't use "la" before or after \\ && the other separators "e", "li", "pi", ".", "!", "?", ":", ",".  \\ 
 && \\ % no-dictionary
...
\textbf{\dots o \dots !} && \textit{separator}: An "o" is used for imperative (commands): "o" replace "li". \\ && Don't use "o" before or after the other separators "e", "li", "pi".       \\ 
 && \\ % no-dictionary
...
\textbf{open la \dots} && \textit{conditional}: firstly, in the beginning  \\ 
 && \\ % no-dictionary\dots
...
\textbf{pona la \dots} && \textit{conditional}: luckily \\ 
 && \\ % no-dictionary
